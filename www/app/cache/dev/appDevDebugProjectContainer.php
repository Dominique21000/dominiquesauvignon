...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ds_internaute.visite' => 'getDsInternaute_VisiteService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DSInternauteBundle', ($this->targetDirs[2].'/Resources/DSInternauteBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DSInternauteBundle', ($this->targetDirs[3].'/src/DS/InternauteBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'dominiqukfds1', 'user' => 'dominiqukfds1', 'password' => '8HBtpSN5qFzY', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/DS/InternauteBundle/Entity'))), 'DS\\InternauteBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('DSInternauteBundle' => 'DS\\InternauteBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1d2580b546ae7649342f02ed9ae715dbc6b6e05debc480761ef7a1a7a43c1977');
    ...
    /**
     * Gets the 'ds_internaute.visite' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DS\InternauteBundle\Visite\SiteVisiter A DS\InternauteBundle\Visite\SiteVisiter instance.
     */
    protected function getDsInternaute_VisiteService()
    {
        return $this->services['ds_internaute.visite'] = new \DS\InternauteBundle\Visite\SiteVisiter($this->get('doctrine.orm.default_entity_manager'), '$page');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('DS\\InternauteBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('DS\\InternauteBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('DS\\InternauteBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('DS\\InternauteBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'DS\\InternauteBundle\\Entity\\User');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'DSInternauteBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/DS/InternauteBundle/Resources/views'), 'DSInternaute');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2393625a0d38f98842819aa880c080d760100626');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DSInternauteBundle' => 'DS\\InternauteBundle\\DSInternauteBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'dominiqukfds1',
            'database_user' => 'dominiqukfds1',
            'database_password' => '8HBtpSN5qFzY',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '2393625a0d38f98842819aa880c080d760100626',
            'locale' => 'fr',
            ...
            'kernel.secret' => '2393625a0d38f98842819aa880c080d760100626',
            ...
            'fos_user.model.user.class' => 'DS\\InternauteBundle\\Entity\\User',
