 ...
 */
class Reference extends \DS\InternauteBundle\Entity\Reference implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Reference' . "\0" . 'id', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Reference' . "\0" . 'titre', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Reference' . "\0" . 'description', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Reference' . "\0" . 'adresse', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Reference' . "\0" . 'logo', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Reference' . "\0" . 'ordre', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Reference' . "\0" . 'actif');
        }
