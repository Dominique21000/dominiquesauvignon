 ...
 */
class Lien extends \DS\InternauteBundle\Entity\Lien implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Lien' . "\0" . 'id', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Lien' . "\0" . 'titre', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Lien' . "\0" . 'adresse', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Lien' . "\0" . 'logo', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Lien' . "\0" . 'description', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Lien' . "\0" . 'ordre', '' . "\0" . 'DS\\InternauteBundle\\Entity\\Lien' . "\0" . 'actif');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Lien $proxy) {
